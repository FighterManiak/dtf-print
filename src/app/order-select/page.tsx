    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-2xl mx-auto px-4 py-16 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <Link
            href="/quote/request"
            className="group flex flex-col items-center text-center p-8 bg-white border-2 border-blue-200 rounded-3xl hover:border-blue-500 hover:shadow-lg transition-all"
          >
            <div className="w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center mb-5 group-hover:bg-blue-200 transition-colors">
            ...
            <div className="mt-auto">
              <span className="inline-block bg-blue-50 text-blue-600 text-xs font-bold px-3 py-1.5 rounded-full">
                롤 출력 · 수량 미확정
              </span>
            </div>
          </Link>
