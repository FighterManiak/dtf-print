...
export default function GradePage() {
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      <p className="text-sm text-gray-500 mb-8">많이 이용하실수록 더 높은 등급과 포인트 적립 혜택을 드립니다.</p>

      <div className="mb-6">
        <GradeGuide />
      </div>

      <div className="bg-white border border-gray-200 rounded-2xl p-5 mb-6 text-sm text-gray-700 leading-relaxed space-y-2">
        <p className="font-bold text-gray-800 mb-1">💜 포인트 혜택</p>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-5 text-sm text-gray-700 leading-relaxed space-y-2">
        <p className="font-bold text-gray-800 mb-1">등급 산정 기준</p>
